...
Usage:
    python -m istota_browse get "https://example.com" [--keep-session] [--timeout 30]
    python -m istota_browse screenshot "https://example.com" [--output /tmp/shot.png]
    python -m istota_browse extract "https://example.com" --selector "article"
    python -m istota_browse interact <session_id> --click ".button" --fill "#input=value"
